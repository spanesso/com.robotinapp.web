                        ...
                        <form class="col s12">
                            ...
                            <div class="row" style="margin-bottom: 0px!important;">
                                <div class="col s6">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            ...
                                            <label for="cleaning_user_name">Name</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="cleaning_user_medicare" type="text" class="validate validate-form">
                                            <label for="cleaning_user_medicare">Medicare</label>
                                        </div>
                                    </div>
                                ...
                                <div class="col s6">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="cleaning_user_other_phone" type="text" class="validate validate-form">
